...
export default class MainProfile extends Component<Props,State>{
  state=initState
  componentDidMount(){
  }
  setActive = () =>{
    ...
    return (
      <Container style={styles.container}>
        <Header searchBar rounded style={styles.header}>
          ...
          <Right>
            <Button transparent>
              <Icon onPress={this.setActive} style={{color:"white"}} name="ios-create" />
            </Button>
          </Right>
        </Header>
        <View style={styles.container}> 
          <ImageBackground source={image} style={styles.image}>
            <MainContent navigation={this.props.navigation} active={this.state.active}/>
          </ImageBackground>
        </View>
      </Container>
    );
